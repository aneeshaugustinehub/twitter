...
export default function Profile() {
  return (
    <>
      {/* Banner */}
      <img
        src="https://pbs.twimg.com/profile_banners/816230761632104448/1605173150/1080x360"
        className="w-full"
        alt="banner"
      />
      ...
      <div className="border border-gray-700 p-3">
        <div className="flex flex-col">
          ...
          <div className="flex justify-between items-start">
            <img
              src="https://pbs.twimg.com/profile_images/1530781694730567680/OvhIKTn2_400x400.jpg"
          ...
          <div className="pt-3">
            ...
            <div className="text-gray-500 flex flex-wrap gap-2 text-sm">
              ...
              <span>
                🔗 <a href="" className="text-blue-400 hover:underline">linktr.ee/angeeg</a>
              </span>
